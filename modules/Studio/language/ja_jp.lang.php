...
'LBL_TABGROUP_LANGUAGE' => 'グループタブ言語:',
...
'LBL_MODULE_NAME' => '管理',
'LBL_CONFIGURE_GROUP_TABS' => 'モジュールメニューフィルターの設定',
 //end bug #15095 fix
...
以下のグループタブのレイアウトはユーザがグループタブの利用を選択した場合に、マイアカウント>レイアウトオプションで通常のモジュールタブの代わりに利用されます。',
'LBL_RENAME_TAB_WELCOME'=>'下記テーブル内の任意のタブの表示名をクリックし、タブの名前を変更してください。',
'LBL_DELETE_MODULE'=>'フィルターから<br />モジュールを削除',
'LBL_DISPLAY_OTHER_TAB_HELP' => 'ナビゲータバーの"その他"タブを表示するために選択してください。デフォルトでは、"その他"タブに他のグループに属さないモジュールが表示されます。',
'LBL_TAB_GROUP_LANGUAGE_HELP' => 'その他の利用可能な言語によるグループタブのラベルを設定するには、言語を選択し、ラベルを編集し、その言語を変更するために保存して配置をクリックしてください。',
'LBL_ADD_GROUP'=>'フィルターを追加',
...
'LBL_SP_SYNC'=>'ポータル同期',
'LBL_SYNCP_WELCOME'=>'更新したいポータルインスタンスのURLを入力し、Goボタンを押してください。ユーザ名とパスワードを入力するプロンプトが表示されるので、Sugarのユーザ名とパスワードを入力し、同期開始ボタンを押してください。',
'LBL_LISTVIEWP_DESCRIPTION'=>'以下にの2つのカラム（表示されるフィールドがある"デフォルト"カラム、表示されませんが表示用として利用可能なフィールドがある”利用可能”カラム）があります。その2つのカラム間でフィールドをドラッグしてください。それらをドラッグ＆ドロップすることによって、カラム内のアイテムを再整理することが可能です。',
...
'LBL_SP_PREVIEW'=>'これがスタイルシートを適用後のプレビューです。',
	...
	'LBL_UNDO' => '戻す' /*for 508 compliance fix*/,
	'LBL_REDO' => '再実行' /*for 508 compliance fix*/,
	'LBL_INLINE' => 'インライン' /*for 508 compliance fix*/,
	'LBL_DELETE' => '削除' /*for 508 compliance fix*/,
	'LBL_ADD_FIELD' => 'フィールド追加' /*for 508 compliance fix*/,
	'LBL_MAXIMIZE' => '最大' /*for 508 compliance fix*/,
	'LBL_MINIMIZE' => '最小' /*for 508 compliance fix*/,
	'LBL_PUBLISH' => '公開' /*for 508 compliance fix*/,
	'LBL_ADDROWS' => '行を追加' /*for 508 compliance fix*/,
	'LBL_ADDFIELD' => 'フィールドを追加' /*for 508 compliance fix*/,
	'LBL_EDIT' => '編集' /*for 508 compliance fix*/,

'LBL_LANGUAGE_TOOLTIP' => '編集したい言語を選択してください。',
'LBL_SINGULAR' => '単数ラベル',
'LBL_PLURAL' => '複数ラベル',
'LBL_RENAME_MOD_SAVE_HELP' => '<b>保存</b>をクリックし変更を適用します。'
