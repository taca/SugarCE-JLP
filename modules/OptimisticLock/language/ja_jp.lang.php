...
$mod_strings = array (
   'LBL_YOURS' => 'あなたのもの',
   'LBL_IN_DATABASE' => 'データベースのもの',
   'LBL_CONFLICT_EXISTS' => '衝突が発生しました - ',
   'LBL_ACCEPT_DATABASE' => 'データベースのものを受け入れる',
   'LBL_ACCEPT_YOURS' => 'あなたのものを受け入れる',
   'LBL_RECORDS_MATCH' => '件マッチしました',
   'LBL_NO_LOCKED_OBJECTS' => 'ロックオブジェクトがありません',
