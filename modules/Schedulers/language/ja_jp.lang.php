...
'LBL_CRONTAB_SERVER_TIME_PRE' =>  'クーロンは以下のタイムゾーンに従い実行されます。(サーバタイムゾーン：',
'LBL_CRONTAB_SERVER_TIME_POST' => ') タイムゾーンを考慮しスケジューラーを設定してください。',
// Labels
'LBL_ALWAYS' => '常に',
...
'NTC_STATUS' => 'スケジューラーのドロップダウンから削除する場合はステータスを無効にしてください。',
...
//jobstrings
'LBL_REFRESHJOBS' => 'ジョブを再読み込み',
'LBL_POLLMONITOREDINBOXES' => '受信メールを確認',
'LBL_PERFORMFULLFTSINDEX' => 'Full-text Search Index System',

'LBL_RUNMASSEMAILCAMPAIGN' => '夜間にキャンペーンメールを送信',
'LBL_POLLMONITOREDINBOXESFORBOUNCEDCAMPAIGNEMAILS' => 'バウンスしたキャンペーンメールを夜間に再実行',
