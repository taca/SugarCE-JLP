...
$mod_strings = array(
	...
	'LBL_UW_END_LOGOUT_PRE2'					=> '完了をクリックするとアップグレードウィザードを終了します。',
    ...
    'LBL_UW_NEXT_TO_UPLOAD'						=> "<b>次へをクリックするとアップグレードパッケージをアップロードします。</b>",
	...
	'LBL_UW_PREFLIGHT_TESTS_PASSED2'			=> '次へをクリックするとシステムにアップグレードファイルをコピーします。',
	'LBL_UW_PREFLIGHT_TESTS_PASSED3'			=> '<b>注意: </b> 残りのアップグレードプロセスは必須となります。よって次へをクリックすると中断ができません。 もし中止したい場合にはキャンセルをクリックしてください。',	
	...
	'LBL_UW_START_DESC3'						=> '次へをクリックするとシステムがアップグレード可能かどうかチェックを行います。 チェックはファイルやデータベースのアクセス権およびサーバの設定を確認します。',
	...
	'LBL_UW_SUGAR_COMMUNITY_EDITION_LICENSE'    => 'Sugar Community Edition 5.0は、Affero GNU General Public License Version 3を使用しています。このアップグレードは、既存のライセンスを以下に表示された新しいライセンスに置き換えます。',
    ...
    'LBL_PREFLIGHT_FILE_COPYING_PROGRESS'       => 'ファイルのコピーを実行中です',
	'LBL_COMMIT_UPGRADE_IN_PROGRESS'            => 'アップグレードのコミット中です',
    'LBL_UW_COMMIT_DESC'						=> '次へをクリックし追加アップグレードスクリプトを実行します。',
	'LBL_UPGRADE_SCRIPTS_IN_PROGRESS'			=> 'アップグレードスクリプトが実行中です',
	...
	'ERR_CHECKSYS_PHP_INVALID_VER'      => 'Sugarは、ご利用のPHPのバージョンをサポートしていません。Sugarアプリケーションに準拠したバージョンをインストールする必要があります。リリースメモ/添付の互換性マトリックスでサポートするPHPのバージョンをご確認ください。ご利用のバージョン ',
	...
	'LBL_CURRENT_PHP_VERSION' => '(PHPのバージョンは ',
	'LBL_RECOMMENDED_PHP_VERSION' => '. PHPの推奨は5.2.1以上です)',
	'LBL_MODULE_NAME' => 'アップグレードウィザード',
	'LBL_UPLOAD_SUCCESS' => 'アップグレードパッケージのアップロードが成功しました。次へをクリックすると最終チェックを行います。',
	'LBL_UW_TITLE_LAYOUTS' => 'レイアウトを確認',
	'LBL_LAYOUT_MODULE_TITLE' => 'レイアウト',
	'LBL_LAYOUT_MERGE_DESC' => 'アップグレード中に自動で既存のレイアウトに追加され利用可能なフィールドがあります。 新しいフィールドの詳細については、アップグレードのバージョンのリリースメモ/添付を参照してください。 <br><br>モジュール、およびカスタムレイアウトに新しいフィールドを追加したくない場合はチェックを外してください。フィールドは、アップグレード後にスタジオで利用できるようになります。 <br><br>',
	'LBL_LAYOUT_MERGE_TITLE' => '変更を確認し次へをクリックしてアップグレードを終了してください。',
	'LBL_LAYOUT_MERGE_TITLE2' => '次へをクリックしアップグレードを完了してください。',
	'LBL_UW_CONFIRM_LAYOUTS' => 'レイアウトを確認',
    'LBL_UW_CONFIRM_LAYOUT_RESULTS' => 'レイアウト確認結果',
    'LBL_UW_CONFIRM_LAYOUT_RESULTS_DESC' => '次のレイアウトのマージに成功しました:',
	...
	'LBL_MODULELOADER' => 'モジュールローダ' /*for 508 compliance fix*/,
	'LBL_PATCHUPGRADES' => 'アップグレードパッチ' /*for 508 compliance fix*/,
	...
	'LBL_PROCESSING' => 'プロセス' /*for 508 compliance fix*/,
);
?>