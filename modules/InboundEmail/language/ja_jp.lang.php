...
$mod_strings = array(
	...
	'LBL_AUTOREPLY_HELP'	=> '送信者へ受信したことを通知するための自動応答機能',
	'LBL_BASIC'				=> '基本設定',
	'LBL_CASE_MACRO'		=> '問合せマクロ',
	'LBL_CASE_MACRO_DESC'	=> '受信したメールを問合せに関連付けるためのマクロを設定してください。',
	...
	'LBL_FILTER_DOMAIN_DESC'=> '自動返信を送信しないドメインを指定してください。',
	'LBL_ASSIGN_TO_GROUP_FOLDER_DESC'=> 'グループフォルダーに電子メールアカウントを割り当て、電子メールの自動インポートを有効にする。',
	'LBL_POSSIBLE_ACTION_DESC'		=> '問合せを作成オプションを選ぶには、グループフォルダーが選択されていなければいけません。',
    ...
    'LBL_FROM_ADDR_DESC'    => "その電子メールアドレスはプロバイダの制限によって「From」アドレスとして表示されない場合があります。その場合には電子メールサーバに定義されたアドレスで送信されます。",
	'LBL_FROM_NAME_ADDR'	=> 'From 名前/メール',
	...
	'LBL_CREATE_CASE_REPLY_TEMPLATE' => '問合せ返信テンプレートの作成',
	'LBL_CREATE_CASE_REPLY_TEMPLATE_HELP' => '問合せが作成されていることを電子メールの送信者に通知するために自動応答を選択します。電子メールは、問合せのマクロの設定に準拠して、件名に問合せ番号が含まれています。最初のメールは受信者から受信したときに、この応答にのみ送信されます。',
	'LBL_MAILBOX'			=> '監視フォルダ',
	...
	'LBL_PERSONAL_MODULE_NAME' => '個人メールアカウント',
	'LBL_CREATE_CASE'      => '電子メールから問合せを作成',
	'LBL_CREATE_CASE_HELP'  => '自動的に受信メールから問合せを作成する場合に選択してください。',
	'LBL_MODULE_NAME'		=> 'グループメールアカウント',
	'LBL_BOUNCE_MODULE_NAME' => 'バウンス処理メール',
	...
	'LBL_ASSIGN_TO_TEAM_DESC' => '選択されたチームは電子メールアカウントへアクセスできます。グループフォルダを選択すると、グループフォルダの担当ユーザチームは選択したチームに上書きされます。',
	'LBL_SSL'				=> 'SSL利用',
	'LBL_STATUS'			=> 'ステータス',
	...
	'LBL_TLS'				=> 'TLS利用',
	'LBL_WARN_IMAP_TITLE'	=> '受信メールが利用できません',
	'LBL_WARN_IMAP'			=> '警告一覧:',
	...
	'LNK_LIST_CREATE_NEW_GROUP'	=> '新規メールアカウントを監視',
	'LNK_LIST_CREATE_NEW_BOUNCE' => '新規バウンス処理',
    ...
    'LBL_ALLOW_OUTBOUND_GROUP_USAGE' => 'ユーザは返信用のアドレスと名前を"From"に使用して電子メールを送信することができます。',
    'LBL_ALLOW_OUTBOUND_GROUP_USAGE_DESC' => 'このオプションが選択された場合、グループメールアカウントにアクセスできるユーザがメールを書くときFromの名前と電子メールアドレスにグループメールアカウントに関連づいた名前と電子メールアドレスが選択できるようになります。',
    'LBL_STATUS_ACTIVE'     => '有効',
    'LBL_STATUS_INACTIVE'   => '無効',
    'LBL_IS_PERSONAL' => '個人',
    'LBL_IS_GROUP' => 'グループ',
    'LBL_ENABLE_AUTO_IMPORT' => '自動インポート',
    'LBL_WARNING_CHANGING_AUTO_IMPORT' => '警告: 自動インポートの設定を変更するとデータの損失の原因になる可能性があります。',
    'LBL_WARNING_CHANGING_AUTO_IMPORT_WITH_CREATE_CASE' => '警告: 自動問合せ作成を有効にするば場合、自動インポートを有効にする必要があります。',
