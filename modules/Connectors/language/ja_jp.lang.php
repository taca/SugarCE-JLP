...
$mod_strings = array (
    ...
    'LBL_ENABLED' => '有効',
    'LBL_EXTERNAL' => '外部から取引先を作成することを許可',
    'LBL_EXTERNAL_SET_PROPERTIES' => 'このコネクタを利用するためには、コネクタのプロパティで設定する必要があります。',
    ...
    'ERROR_NO_SEARCHDEFS_MAPPED' => 'エラー: 定義されたフィールドを検索可能なコネクタはありません。',
