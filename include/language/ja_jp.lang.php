...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
  'language_pack_name' => 'Japanese - 日本語',
  'moduleList' =>
  array (
    'Home' => 'ホーム',
    'Contacts' => '取引先担当者',
    ...
    'Campaigns'=>'キャンペーン',
    'CampaignLog'=>'キャンペーン履歴',
    'Documents'=>'ドキュメント',
    'DocumentRevisions'=>'改定履歴',
    'Connectors'=>'コネクタ',
    'Roles'=>'ロール',
    'Notifications'=>'通知',
    'Sync'=>'同期',
  ...
  //e.g. en fran・ｽais 'Analyst'=>'Analyste',
  'account_type_dom' =>
  array (
    '' => '',
    'Analyst' => 'アナリスト',
...
//       it is the key for the default record_type_module value
 ...
 'case_type_dom' =>
  ...
  array (
    ...
    'dom_email_distribution_for_auto_create'=> array('roundRobin'   => 'ラウンドロビン',
                                                     'leastBusy'    => '稼働率',
    ),
...
$app_strings = array (
  'LBL_MY_AREA_LINKS' => '私のリンク: ' /*for 508 compliance fix*/,
  ...
  'LBL_VIEW_INLINE' => 'ビュー' /*for 508 compliance fix*/,
  ...
  'LBL_ICON_COLUMN_2' => '2 カラム' /*for 508 compliance fix*/,
  'LBL_ICON_COLUMN_3' => '3 カラム' /*for 508 compliance fix*/,
  'LBL_ADVANCED_SEARCH' => '詳細検索' /*for 508 compliance fix*/,
  'LBL_ID_FF_ADD' => '追加' /*for 508 compliance fix*/,
  'LBL_HIDE_SHOW' => '隠す/見る' /*for 508 compliance fix*/,
  ...
  'LBL_COMPANY_LOGO' => '会社のロゴ' /*for 508 compliance fix*/,
  'LBL_JS_CALENDAR' => 'カレンダー' /*for 508 compliance fix*/,
    'LBL_ADVANCED' => '詳細',
    'LBL_BASIC' => '基本',
    'LBL_MODULE_FILTER' => 'フィルター',
    'LBL_CONNECTORS_POPUPS'=>'コネクタ',
    'LBL_CLOSEINLINE'=>'閉じる',
    'LBL_MOREDETAIL'=>'詳細',
    'LBL_EDITINLINE'=>'編集',
    'LBL_VIEWINLINE'=>'ビュー',
	...
	'LBL_EMAIL_SMTP_SSL_OR_TLS'					=> 'SMTP over SSL or TLS を利用?',
    'LBL_NO_ACTION'                         => 'URLに誤りがあります。アクションがありません。',
    'LBL_NO_DATA'                           => 'データがありません。',
    ...
    'LBL_EMAIL_ACCOUNTS_SMTPDEFAULT'        => '標準',
    'LBL_EMAIL_WARNING_MISSING_USER_CREDS'  => '警告: 送信メールアカウントのユーザ名またはパスワードに誤りがあります。',
    'LBL_EMAIL_ACCOUNTS_SMTPUSER_REQD'      => 'SMTP ユーザ名は必須です。',
    'LBL_EMAIL_ACCOUNTS_SMTPPASS_REQD'      => 'SMTP パスワードは必須です。',
    'LBL_EMAIL_ACCOUNTS_TITLE'              => '電子メールアカウント管理',
    'LBL_EMAIL_POP3_REMOVE_MESSAGE'			=> 'POP3はサポートされていません。IMAPのみとなります。',
	'LBL_EMAIL_ACCOUNTS_SUBTITLE'           => '電子メールアカウントの受信メールを表示するための設定を行います。',
	'LBL_EMAIL_ACCOUNTS_OUTBOUND_SUBTITLE'  => 'メールを送信するために利用するSMTPサーバの情報を設定します。',
    ...
    'LBL_EMAIL_REMOVE_SMTP_WARNING'         => '警告! この送信用メールサーバは既存の受信メールサーバに設定されています。削除を続行しますか?',
    ...
    'LBL_EMAIL_ASSIGNED_TO_USER'            =>'担当ユーザ',
    ...
    'LBL_EMAIL_ERROR_NO_OUTBOUND'           => '送信用メールサーバの設定がされていません。',
    ...
    'LBL_EMAIL_FOLDERS_RENAME_DIALOG_TITLE' => 'フォルダ名の変更',
    ...
    'LBL_EMAIL_NO'                          => 'いいえ',
    'LBL_EMAIL_NOT_SENT'                    => 'システムはリクエストを処理できませんでした。システム管理者へ連絡してください。',
    ...
    'LBL_EMAIL_OPT_OUT_AND_INVALID'         => 'メール不可/不正',
    ...
    'LBL_EMAIL_QC_BUGS'                     => '不具合管理',
    'LBL_EMAIL_QC_CASES'                    => '問合せ',
    ...
    'LBL_EMAIL_SEARCH'                      => '<img src='.SugarThemeRegistry::current()->getImageURL('Search.gif').' align=absmiddle border=0> 検索',
    ...
    'LBL_EMAIL_SETTINGS_TO_EMAIL_ADDR'      => '送信先(To)メールアドレス',
    'LBL_EMAIL_SETTINGS_FROM_NAME'          => '送信元名',
    'LBL_EMAIL_SETTINGS_REPLY_TO_ADDR'      =>'返信用アドレス',
    'LBL_EMAIL_SETTINGS_FULL_SCREEN'        => 'フルスクリーン',
    'LBL_EMAIL_SETTINGS_FULL_SYNC'          => 'すべてのアカウントを同期',
    'LBL_EMAIL_TEST_NOTIFICATION_SENT'      => '本設定で指定したメールアドレスへテストメールを送信しました。設定が正しいかどうか確認するため、メールが受信できるかどうか確認してください。',
	...
	'LBL_EMAIL_INVALID_PERSONAL_OUTBOUND' => '選択された送信用メールサーバは無効です。  設定を確認するか別のメールサーバを選択してください。',
	'LBL_EMAIL_INVALID_SYSTEM_OUTBOUND' => '選択された送信用メールサーバは無効です。  設定を確認するか別のメールサーバを選択してください。',
    ...
    'LBL_EMAIL_TEMPLATE_EDIT_PLAIN_TEXT'    => '本文が空です。',
    ...
    'LBL_EMAIL_TEST_OUTBOUND_SETTINGS_SENT' => 'テストメール送信',
    ...
    'LBL_LINK_MORE'=> 'もっと',
    'LBL_CLOSE_ACTIVITY_HEADER' => "承認",
    'LBL_CLOSE_ACTIVITY_CONFIRM' => "この #module# を完了しますか?",
    'LBL_CLOSE_ACTIVITY_REMEMBER' => "このメッセージを今後表示しない。: &nbsp;",
    'LBL_INVALID_FILE_EXTENSION' => 'ファイルの拡張子が不正です。',


    'ERR_AJAX_LOAD'     => 'AJAX-エラーが発生しました:',
    'ERR_AJAX_LOAD_FAILURE'     => '処理中にエラーが発生しました。しばらくたってから再度やり直してください。',
    'ERR_AJAX_LOAD_FOOTER' => 'このエラーが頻発する場合にはこのモジュールのAJAX機能を無効にするよう管理者へ通知してください。',
    ...
    'ERR_EXTERNAL_API_SAVE_FAIL' => '外部アカウントに保存時にエラーが発生しました。',
    'ERR_EXTERNAL_API_UPLOAD_FAIL' => 'アップロード中にエラーが発生しました。アップロードするファイルが空でないことを確認してください。',
    'ERR_NO_DB' => 'データベースに接続できませんでした。詳細については、sugarcrm.logを参照してください。',
    'ERR_DB_FAIL' => 'データベースエラー。詳細については、sugarcrm.logを参照してください。',
    'ERR_EXTERNAL_API_403' => 'アクセスが拒否されました。ファイルタイプはサポートされていません。',
    ...
    'LBL_REPLACE_BUTTON' => '変更する',
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_KEY' => 'L',
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_LABEL' => '送付対象者リストに追加',
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_TITLE' => '送付対象者リストに追加',
    ...
    'LBL_CHANGE_PASSWORD' => 'パスワードを変更する',
    ...
    'LBL_CLOSE_AND_CREATE_BUTTON_LABEL' => '完了後新規作成',
    'LBL_CLOSE_AND_CREATE_BUTTON_TITLE' => '完了後新規作成',
    'LBL_CLOSE_AND_CREATE_BUTTON_KEY' => 'C',
    'LBL_OPEN_ITEMS' => '未完了:',
    'LBL_COMPOSE_EMAIL_BUTTON_KEY' => 'L',
    'LBL_COMPOSE_EMAIL_BUTTON_LABEL' => '電子メール作成',
    'LBL_COMPOSE_EMAIL_BUTTON_TITLE' => '電子メール作成',
    ...
    'LBL_FAVORITES' => 'お気に入り',
    'LBL_FILTER_MENU_BY' => 'フィルターメニュー',
    'LBL_VCARD' => 'vCard',
    'LBL_EMPTY_VCARD' => 'vCard ファイルを選択してください。',
    ...
    'LBL_LAST_VIEWED' => '最近に参照',
    'LBL_SHOW_LESS' => '表示を少なく',
    'LBL_SHOW_MORE' => '表示を多く',
    ...
    'LBL_THEME_PICKER_IE6COMPAT_CHECK' => '警告: Internet Explorer 6 は非サポートです。よろしければOKをクリックしてください。',
    ...
    'LBL_NO_MASS_UPDATE_FIELDS_AVAILABLE' => '一括更新可能なフィールドはありません。',
    ...
    'LBL_PRIMARY_ADDRESS_CITY' => '主な市区町村:',
    'LBL_PRIMARY_ADDRESS_COUNTRY' => '主な国:',
    'LBL_PRIMARY_ADDRESS_POSTALCODE' => '主な郵便番号:',
    'LBL_PRIMARY_ADDRESS_STATE' => '主な都道府県:',
    'LBL_PRIMARY_ADDRESS_STREET_2' => '主な住所 2:',
    'LBL_PRIMARY_ADDRESS_STREET_3' => '主な住所 3:',
    'LBL_PRIMARY_ADDRESS_STREET' => '主な番地:',
    'LBL_PRIMARY_ADDRESS' => '主な住所:',

	'LBL_BILLING_STREET'=> '住所:',
	'LBL_SHIPPING_STREET'=> '住所:',
    ...
    'LBL_TABGROUP_SALES' => '営業支援',
    'LBL_TABGROUP_SUPPORT' => '問合せ対応',
    ...
    'LBL_VIEW_PDF_BUTTON_TITLE' => 'PDFを印刷',

    'LNK_ABOUT' => '製品について',
    'LNK_ADVANCED_SEARCH' => '詳細検索',
    'LNK_BASIC_SEARCH' => '基本検索',
    'LNK_SEARCH_FTS_VIEW_ALL' => 'すべての結果を表示',
    'LNK_SEARCH_NONFTS_VIEW_ALL' => 'すべて表示',
    'LNK_CLOSE' => '閉じる',
    'LBL_MODIFY_CURRENT_SEARCH'=> '検索を編集する',
    ...
    'MSG_JS_ALERT_MTG_REMINDER_CALL_MSG' => "\nOKをクリックしてこの電話を参照するか、キャンセルをクリックしてください。",
  	'MSG_JS_ALERT_MTG_REMINDER_MEETING_MSG' => "\nClick OK to view this meeting or click Cancel to dismiss this message.",
 	'MSG_LIST_VIEW_NO_RESULTS_BASIC' => "結果はありません。",
	'MSG_LIST_VIEW_NO_RESULTS' => "<item1>の結果はありません。",
 	'MSG_LIST_VIEW_NO_RESULTS_SUBMSG' => "新しい<item2>として<item1>を作成",
	'MSG_EMPTY_LIST_VIEW_NO_RESULTS' => "保存するレコードがありません。今は<item2>や<item3>のだけです。",
    ...
    'ERR_CANNOT_CREATE_METADATA_FILE' => 'エラー: ファイル[[file]]がありません。対応するHTMLファイルがみつからないため作成できません。',
    ...
    'LBL_SEARCH_RESULTS_FOUND' => '検索の結果',
    'LBL_SEARCH_RESULTS_TIME' => 'ミリ秒。',
    ...
    'LBL_PORTAL_WELCOME_INFO' => 'Sugar Portalは問合せ、バグ、メルマガを素早くお客様に提供するフレームワークです。 どのようなWebサイトにも配置可能なSugarの外部インターフェースです。将来のバージョンでプロジェクトマネージメントやフォーラムなどのセルフサービス機能が提供され次第、お伝えします。',
    'LBL_LIST' => '一覧',
    'LBL_CREATE_CASE' => '問合せ作成',
	...
	'LBL_COLLECTION_PRIMARY' => 'メイン',
	'ERROR_MISSING_COLLECTION_SELECTION' => '必須フィールドが空です。',
    'LBL_COLLECTION_EXACT' => '要求',
	...
	'LBL_TOMORROW'=>'明日',
	'LBL_NEXT_WEEK'=> '翌週',
	'LBL_NEXT_MONDAY'=>'次の月曜日',
	'LBL_NEXT_FRIDAY'=>'次の金曜日',
	'LBL_TWO_WEEKS'=> '翌々週',
	'LBL_NEXT_MONTH'=> '翌月',
	'LBL_FIRST_DAY_OF_NEXT_MONTH'=> '翌月最初の金曜日',
	'LBL_THREE_MONTHS'=> '3ヵ月後',
	'LBL_SIXMONTHS'=> '6ヶ月後',
	'LBL_NEXT_YEAR'=> '翌年',
    'LBL_FILTERED' => 'フィルタ指定',
    ...
    'LBL_INVALID_USA_PHONE_FORMAT' => '市外局番を含めた米国の電話番号を入力してくだいさい。',

    //File write error label
    'ERR_FILE_WRITE' => 'エラー: ファイルに書き込みできません。 {0}  サーバの権限を確認してください。',
	'ERR_FILE_NOT_FOUND' => 'エラー: ファイルを読み込みできません。 {0}  サーバの権限を確認してください。',

    'LBL_AND' => '～',
    'LBL_BEFORE' => 'より前',

    // File fields
    'LBL_UPLOAD_FROM_COMPUTER' => 'アップロードしてください。',
    'LBL_SEARCH_EXTERNAL_API' => '外部ソースファイル',
    ...
    'LBL_RSS_FEED' => 'RSS フィード',
    'LBL_RSS_RECORDS_FOUND' => '件見つかりました',
    'ERR_RSS_INVALID_INPUT' => 'RSS はinput_typeが不正です',
    'ERR_RSS_INVALID_RESPONSE' => 'RSS はresponse_type が不正です',

    //External API Error Messages
    'ERR_GOOGLE_API_415' => 'Google Docs でサポートされていないファイルフォーマットです。',
...
"インポート可能なサンプルインポートファイルです。"
"ファイルはカンマ区切り(.csv)です。フィールドの修飾子として二重引用符(\")を使用しています。

"最初の行はヘッダー行です。表示ラベルと同じ名前が表示されます。"
"これらのラベルは、アプリケーション内のフィールドにファイル内のデータをマッピングするために使用されています。"

"注意: ヘッダー行の中にデータベースのフィールド名を用いることができます。これは phpMyAdmin やその他のデータベースツールからエクスポートしたデータを利用する際に便利です。"
"インポートプロセスは、ヘッダー行に基づいて適切なフィールドにデータを関連付けるため列の順序は重要ではありません。"


"このファイルをテンプレートとして使用するには次の操作を行います:"
"1. サンプルデータ行を削除"
"2. 今読んでいるヘルプテキストを削除"
"3. 適切な行と列へデータを入力"
"4. ファイルを保存"
"5. アクションメニューからインポートをクリックしファイルを選択しアップロード"
   ',
    //define labels to be used for overriding local values during import/export
    'LBL_EXPORT_ASSIGNED_USER_ID' => '担当ユーザ',
    'LBL_EXPORT_ASSIGNED_USER_NAME' => '担当ユーザ名',
    'LBL_EXPORT_REPORTS_TO_ID' => 'Reports To ID',
    'LBL_EXPORT_FULL_NAME' => '姓名',
    'LBL_EXPORT_TEAM_ID' => 'Team ID',
    'LBL_EXPORT_TEAM_NAME' => 'Teams',
    'LBL_EXPORT_TEAM_SET_ID' => 'Team Set ID',

    'LBL_QUICKEDIT_NODEFS_NAVIGATION'=> '進行中... ',
    ...
    'LBL_ALT_SORT' => 'ソート順',
    'LBL_ALT_SHOW_OPTIONS' => 'オプションを表示',
    'LBL_ALT_HIDE_OPTIONS' => 'オプションを非表示',
    'LBL_ALT_MOVE_COLUMN_LEFT' => '左側のリストに選択したアイテムを移動する',
    'LBL_ALT_MOVE_COLUMN_RIGHT' => '右側のリストに選択したアイテムを移動する',
    'LBL_ALT_MOVE_COLUMN_UP' =>'表示されたリストの順に選択したアイテムを上に移動',
    'LBL_ALT_MOVE_COLUMN_DOWN' => '表示されたリストの順に選択したアイテムを下に移動',
    'LBL_ALT_INFO' => '情報',
    ...
    'LBL_EMAIL_OPT_TITLE' => '送付禁止電子メール',
    'LBL_EMAIL_INV_TITLE' => '不正な電子メール',
    'LBL_EMAIL_PRIM_TITLE' => 'メイン電子メール',
    'LBL_SELECT_ALL_TITLE' => '全て選択',
    'LBL_SELECT_THIS_ROW_TITLE' => 'このレコードだけ選択',
...
$app_list_strings['moduleList']['EmailAddresses'] = '電子メールアドレス';
